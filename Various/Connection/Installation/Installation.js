...
function setup() {
   console.log(ageVector);
    ...
    flippedVideo = pg = createGraphics(200, 200);
...
function draw() {
    ...
    let dWidth = 200; //Number: the width of the destination rectangle
    let dHeight = 200;//Number: the height of the destination rectangle
